...
from databuilder.extractor.datafold_lineage_extractor import DatafoldLineageExtractor
...
def create_datafold_lineage_job(metadata_type, host, api_key):
    tmp_folder = f'/var/tmp/amundsen/{metadata_type}'
    node_files_folder = f'{tmp_folder}/nodes'
    relationship_files_folder = f'{tmp_folder}/relationships'

    lineage_extractor = DatafoldLineageExtractor()
    csv_loader = FsNeo4jCSVLoader()

    task = DefaultTask(extractor=lineage_extractor,
                       loader=csv_loader,
                       transformer=NoopTransformer())

    job_config = ConfigFactory.from_dict({
        f'extractor.datafold_lineage_extractor.{DatafoldLineageExtractor.HOST_KEY}': host,
        f'extractor.datafold_lineage_extractor.{DatafoldLineageExtractor.API_KEY_KEY}': api_key,
...
if __name__ == "__main__":
    job1 = create_datafold_lineage_job('datafold_lineage',
